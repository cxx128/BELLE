...
JOB_NAME=${JOB_NAME:-"chatglm3_pretrain0830_fp16_t21_len512_n256_resume"}
GPUS=${1:-256} # 256正式跑，测试用16
...
output_dir=${3:-"/work/home/acehekbmzh/cxx/BELLE/train/work_dirs/20240919_pretrain_glm_len512"}
batch_size=${4:-1}
gradient_accumulation_steps=${5:-1}
epochs=${6:-1}
learning_rate=${7:-1e-6} # 11.5之前默认的是2e-4
#train_file=${9:-'/work/home/acehekbmzh/cxx/dataset/20240901pretrain/pretrain_all_0903.json'} # debug file
multiple_preprocessed_dataset_files_config=${8:-"/work/home/acehekbmzh/cxx/BELLE/train/configs/multiple_dataset_files_config_test.json"}
validation_file=${10:-'/work/home/acehekbmzh/cxx/dataset/20240901pretrain/chatglm3_CLUE_3_val_len512.json'}
negative=${11:-0.2}
deepspeed_config_file=${12:-"/work/home/acehekbmzh/cxx/BELLE/train/configs/deepspeed_config_stage3_glm3_0915_t13.json"}
PY_ARGS=${@:3}
...
srun --partition=${partition} $SRUN_ARGS  \
    ...
    --resume_from_checkpoint /work/home/acehekbmzh/cxx/BELLE/train/work_dirs/20240919_pretrain_glm_len512/train/checkpoint-15318
    #--bf16 \
    #--fp16 False \

...
JOB_NAME=${JOB_NAME:-"llama_pretrain0830_fp32_t21_len1024"}
GPUS=${1:-128} # 256正式跑，测试用16
model_name_or_path=${2:-"/work/home/acehekbmzh/data/hf_home/linly_chinese_llama_7b_hf"}  # /public/home/hpctest_xjtu/data/hf_home/bloom-7b1 # or bloomz-7b1-mt
output_dir=${3:-"/work/home/acehekbmzh/cxx/BELLE/train/work_dirs/20240901_pretrain"}
batch_size=${4:-2}
...
multiple_preprocessed_dataset_files_config=${8:-"/work/home/acehekbmzh/cxx/BELLE/train/configs/multiple_dataset_files_config.json"}
validation_file=${10:-'/work/home/acehekbmzh/cxx/dataset/20240901pretrain/CLUE_8_llama2_for_val.json'}
negative=${11:-0.2}

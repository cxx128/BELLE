...
train_file=/mnt/afs/chenxiaoxuan/BELLE/debug/long_seq_6k.json
...
output_dir="$ABS_PATH/BELLE/train/work_dirs/sft/test_sft_long_context"
mkdir -p ${output_dir}
...
#FT
torchrun --master_port 29503 --nproc_per_node 4 src/entry_point/sft_train.py \
     --ddp_timeout 36000 \

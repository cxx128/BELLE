...
JOB_NAME=${JOB_NAME:-"cxx_debug"}
GPUS=${1:-8} # 256正式跑，测试用16
OUTPUT_LOG_DIR=${3:-"/work/home/acehekbmzh/cxx/BELLE/train/work_dirs/cxx_debug"}
...
srun --partition=${partition} $SRUN_ARGS  \
    ...
    python  /work/home/acehekbmzh/cxx/BELLE/train/src/entry_point/cxx_debug.py \

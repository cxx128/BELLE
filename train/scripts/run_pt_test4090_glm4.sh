...
model_name_or_path=/mnt/afs/chenxiaoxuan/hf_home/GLM-4-9B-Chat-HF # or bloomz-7b1-mt

train_file=/mnt/afs/chenxiaoxuan/BELLE/data/dataset/20240901pretrain/debug/pretrain_all_qwen_0927_len1024_split_00.json
validation_file=/mnt/afs/chenxiaoxuan/BELLE/data/dataset/20240901pretrain/debug/pretrain_all_qwen_0927_len1024_split_00.json
#output_dir="$ABS_PATH/BELLE/saved_models/${WANDB_PROJECT}_${WANDB_RUN_ID}"
output_dir="$ABS_PATH/BELLE/train/work_dirs/debug/test4090"
mkdir -p ${output_dir}

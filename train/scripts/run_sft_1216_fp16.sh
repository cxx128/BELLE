...
model_name_or_path=/mnt/afs/chenxiaoxuan/hf_home/Qwen2.5-7B-Instruct # or bloomz-7b1-mt
...
validation_file=/mnt/afs/chenxiaoxuan/Projects_2024_cxx/20241118/data_belle/origin_table_current/origin_table_train.json
#output_dir="$ABS_PATH/BELLE/saved_models/${WANDB_PROJECT}_${WANDB_RUN_ID}"
output_dir="$ABS_PATH/BELLE/train/work_dirs/sft/test_sft2"
mkdir -p ${output_dir}
...
#FT
torchrun --master_port 29502 --nproc_per_node 2 src/entry_point/sft_train.py \
     --ddp_timeout 36000 \

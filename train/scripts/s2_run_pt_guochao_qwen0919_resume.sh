...
JOB_NAME=${JOB_NAME:-"qwen_pretrain927_fp16_t21_len1024_n128_bs4_resume"}
GPUS=${1:-128} # 256正式跑，测试用16
model_name_or_path=${2:-"/work/home/acehekbmzh/data/hf_home/qwen1.5_7b"}  # /public/home/hpctest_xjtu/data/hf_home/bloom-7b1 # or bloomz-7b1-mt
output_dir=${3:-"/work/home/acehekbmzh/cxx/BELLE/train/work_dirs/20240919_pretrain_qwen"}
batch_size=${4:-2}
...
multiple_preprocessed_dataset_files_config=${8:-"/work/home/acehekbmzh/cxx/BELLE/train/configs/multiple_dataset_files_config_qwen.json"}
validation_file=${10:-'/work/home/acehekbmzh/cxx/dataset/20240901pretrain/qwen_CLUE_len1024_val.json'}
negative=${11:-0.2}
deepspeed_config_file=${12:-"/work/home/acehekbmzh/cxx/BELLE/train/configs/deepspeed_config_stage3_llama0830_test.json"}
PY_ARGS=${@:3}
...
srun --partition=${partition} $SRUN_ARGS  \
    ...
    --resume_from_checkpoint /work/home/acehekbmzh/cxx/BELLE/train/work_dirs/20240919_pretrain_qwen/train/checkpoint-7800
    #--bf16 \
    #--fp16 False \

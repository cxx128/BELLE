...
class CustomTrainer(Trainer):
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for _ in range(total_updates):
                ...
                for i, inputs in enumerate(batch_samples):
                    step += 1
                    #x_device=inputs['input_ids'].device
                    #print(f'decive: {x_device} step: {step} time1: {time.time()}')
                    ...
                    if do_sync_step:
                        ...
                        #x_device=inputs['input_ids'].device
                        #print(f'decive: {x_device} step: {step} time5: {time.time()}')
    ...
    def training_step(
        ...
        #x_device=inputs['input_ids'].device
        #print(f'decive: {x_device} step:  time2: {time.time()}')
        ...
        #print(f'decive: {x_device} step:  time3: {time.time()}')
        ...
        if self.use_apex:
            ...
            #print(f'decive: {x_device} step:  time4: {time.time()}')
            return loss.detach()
